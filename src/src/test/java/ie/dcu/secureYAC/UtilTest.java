...
public class UtilTest {
    ...
    public void testByteArrayToBigIntToByteArray() {
        ...
        assertEquals(arrBigInt.toString(2),
                Util.byteArrayToBigInteger(result).toString(2));
    }
    ...
    public void testLoadFromIdFile() throws Exception {
        ...
        for (File f : new File(".").listFiles()) {
            ...
            if (fileName.endsWith(".id")) {
                ...
                assertArrayEquals(
                        identity.getPreKeyPrivate(), loaded.getPreKeyPrivate());
    ...
    public void testLoadFromPkbFile() throws Exception {
        ...
        for (File f : new File(".").listFiles()) {
            ...
            if (fileName.endsWith(".pkb")) {
                ...
                assertArrayEquals(
                        preKey.getPreKeyPublic(), loaded.getPreKeyPublic());
                assertArrayEquals(
                        preKey.getPreKeySignature(), loaded.getPreKeySignature());
                assertArrayEquals(
                        preKey.getOneTimePreKey(), loaded.getOneTimePreKey());
            }
        }
    }
}
