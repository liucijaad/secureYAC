...
public class X25519 {
    public static final BigInteger PRIME = new BigInteger(
            "7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFED", 16);
    public static final BigInteger BASE_POINT = new BigInteger(
            "20AE19A1B8A086B4E01EDD2C7748D14C923D4D7E6D7C61B229E9C5A27ECED3D9", 16);
    ...
    public static byte[] generatePrivateKey() {
        ...
        if (keyInt.equals(BigInteger.ZERO)) { // Generate new key if privateKey == 0.
